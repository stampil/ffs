...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000000276485d000000004af6b0c9(
...
class phpbbtemplatetwiglexer_000000000276485d000000004af6b0c9 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c153baf82884959204611 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c153baf82892897097015 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c153baf82860018780838 = array(
    ...
    {
        $this->initializer5c153baf82892897097015 && ($this->initializer5c153baf82892897097015->__invoke($valueHolder5c153baf82884959204611, $this, 'set_environment', array('env' => $env), $this->initializer5c153baf82892897097015) || 1) && $this->valueHolder5c153baf82884959204611 = $valueHolder5c153baf82884959204611;

        return $this->valueHolder5c153baf82884959204611->set_environment($env);
    }
    ...
    {
        $this->initializer5c153baf82892897097015 && ($this->initializer5c153baf82892897097015->__invoke($valueHolder5c153baf82884959204611, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5c153baf82892897097015) || 1) && $this->valueHolder5c153baf82884959204611 = $valueHolder5c153baf82884959204611;

        return $this->valueHolder5c153baf82884959204611->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5c153baf82892897097015 && ($this->initializer5c153baf82892897097015->__invoke($valueHolder5c153baf82884959204611, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5c153baf82892897097015) || 1) && $this->valueHolder5c153baf82884959204611 = $valueHolder5c153baf82884959204611;

        return $this->valueHolder5c153baf82884959204611->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5c153baf82892897097015 = $initializer;
    }
    ...
    {
        $this->initializer5c153baf82892897097015 && ($this->initializer5c153baf82892897097015->__invoke($valueHolder5c153baf82884959204611, $this, '__get', array('name' => $name), $this->initializer5c153baf82892897097015) || 1) && $this->valueHolder5c153baf82884959204611 = $valueHolder5c153baf82884959204611;

        if (isset(self::$publicProperties5c153baf82860018780838[$name])) {
            return $this->valueHolder5c153baf82884959204611->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c153baf82884959204611;
    ...
    {
        $this->initializer5c153baf82892897097015 && ($this->initializer5c153baf82892897097015->__invoke($valueHolder5c153baf82884959204611, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c153baf82892897097015) || 1) && $this->valueHolder5c153baf82884959204611 = $valueHolder5c153baf82884959204611;
    ...
    {
        $this->initializer5c153baf82892897097015 && ($this->initializer5c153baf82892897097015->__invoke($valueHolder5c153baf82884959204611, $this, '__isset', array('name' => $name), $this->initializer5c153baf82892897097015) || 1) && $this->valueHolder5c153baf82884959204611 = $valueHolder5c153baf82884959204611;
    ...
    {
        $this->initializer5c153baf82892897097015 && ($this->initializer5c153baf82892897097015->__invoke($valueHolder5c153baf82884959204611, $this, '__unset', array('name' => $name), $this->initializer5c153baf82892897097015) || 1) && $this->valueHolder5c153baf82884959204611 = $valueHolder5c153baf82884959204611;
    ...
    {
        $this->initializer5c153baf82892897097015 && ($this->initializer5c153baf82892897097015->__invoke($valueHolder5c153baf82884959204611, $this, '__clone', array(), $this->initializer5c153baf82892897097015) || 1) && $this->valueHolder5c153baf82884959204611 = $valueHolder5c153baf82884959204611;

        $this->valueHolder5c153baf82884959204611 = clone $this->valueHolder5c153baf82884959204611;
    }

    public function __sleep()
    {
        $this->initializer5c153baf82892897097015 && ($this->initializer5c153baf82892897097015->__invoke($valueHolder5c153baf82884959204611, $this, '__sleep', array(), $this->initializer5c153baf82892897097015) || 1) && $this->valueHolder5c153baf82884959204611 = $valueHolder5c153baf82884959204611;

        return array('valueHolder5c153baf82884959204611');
    }
    ...
    {
        return $this->initializer5c153baf82892897097015;
    }
    ...
    {
        return $this->initializer5c153baf82892897097015 && ($this->initializer5c153baf82892897097015->__invoke($valueHolder5c153baf82884959204611, $this, 'initializeProxy', array(), $this->initializer5c153baf82892897097015) || 1) && $this->valueHolder5c153baf82884959204611 = $valueHolder5c153baf82884959204611;
    }
    ...
    {
        return null !== $this->valueHolder5c153baf82884959204611;
    }
    ...
    {
        return $this->valueHolder5c153baf82884959204611;
    }
